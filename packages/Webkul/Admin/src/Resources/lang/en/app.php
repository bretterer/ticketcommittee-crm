        ...
        'index' => [
            ...
            'email' => [
                ...
                'postmark' => [
                    ...
                    'info'  => 'Receive inbound emails via Postmark webhook.',

                    'general' => [
                        'title'                    => 'Postmark Settings',
                        'title-info'               => 'Configure Postmark inbound email webhook settings.',
                        'enabled'                  => 'Enable Postmark Webhook',
                        'webhook-token'            => 'Webhook Token',
                        'webhook-token-info'       => 'Optional security token for webhook verification. If set, include it in requests via Bearer token, Basic auth, query parameter (?token=), or X-Postmark-Token header.',
                        'webhook-url'              => 'Webhook URL',
                        'webhook-url-info'         => 'Copy this URL and paste it into your Postmark inbound webhook configuration.',
                        'copy-url'                 => 'Copy URL',
                        'auto-tag-mappings'        => 'Auto-Tag Mappings',
                        'auto-tag-mappings-info'   => 'Automatically tag incoming emails based on recipient address.',
                        'email-placeholder'        => 'sales@example.com',
                        'display-name-placeholder' => 'Display Name (e.g. Sales Team)',
                        'select-tag'               => 'Select tag...',
                        'create-tag'               => 'Create tag',
                        'type-to-search'           => 'Type to search tags...',
                        'add-mapping'              => 'Add Another Mapping',
                    ],
                ],
            ],
